...
void myproject(
    ...
    #pragma HLS INTERFACE ap_vld port=fc1_input,layer14_out 
    #pragma HLS PIPELINE 
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<weight5_t, 240>(w5, "w5.txt");
        ...
        nnet::load_weights_from_txt<weight14_t, 4>(w14, "w14.txt");
