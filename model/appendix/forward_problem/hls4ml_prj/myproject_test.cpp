...
int main(int argc, char **argv)
{
  ...
  if (fin.is_open() && fpr.is_open()) {
    while ( std::getline(fin,iline) && std::getline (fpr,pline) ) {
      ...
      myproject(fc1_input,layer21_out,size_in1,size_out1);
      ...
      if (e % CHECKPOINT == 0) {
        ...
        nnet::print_result<result_t, N_LAYER_20>(layer21_out, std::cout, true);
      }
      e++;

      //hls-fpga-machine-learning insert tb-output
      nnet::print_result<result_t, N_LAYER_20>(layer21_out, fout);
